...
- `mood` — rating/emoji value (scale TBD during implementation — e.g. 1–5 or a fixed emoji set)
- `createdAt` — timestamp
- `updatedAt` — timestamp
...
- Exact mood scale representation (numeric 1–5 vs. fixed emoji set vs. both).
